...
Search your personal document library, write and edit books, and curate saved sources — all from Claude Code.

## What is CandleKeep?

CandleKeep Cloud is a personal document library where you upload PDFs and markdown files. This skill gives Claude Code direct access to your library so you can research your documents, get cited answers, write new books, and organize saved sources without leaving your terminal.
...
- **Curate:** "Turn my saved tweets about Rust into a document"
